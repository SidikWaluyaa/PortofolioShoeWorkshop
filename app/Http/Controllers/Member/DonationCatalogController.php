...
class DonationCatalogController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('member.katalog.index', compact('items', 'categories', 'settings', 'activeCampaigns', 'activeCampaign', 'maxPriceLimit'));
    }
    ...
    public function filter(Request $request)
    {
        ...
        return view('member.katalog.partials.item-grid', compact('items'))->render();
    }
    ...
    public function requestItem(Request $request, DonationItem $item)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'redirect_url' => $waUrl,
                'message' => 'Permintaan donasi berhasil dikirim!'
            ]);

        } catch (\Exception $e) {
            Log::error('Donation request submission failed inside member panel: ' . $e->getMessage());
            return response()->json([
