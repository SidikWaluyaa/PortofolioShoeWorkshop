...
@section('content')
    ...
    <main class="pt-20">
        <div class="relative overflow-hidden bg-home-grid w-full">
            ...
            {{-- 5. REVIEW --}}
            <section id="review"
                class="py-20 sm:py-24 bg-[#22AF85] border-y border-[#22AF85] scroll-mt-20 relative z-10 text-white"
                    ...
                    <div class="flex flex-col items-center text-center gap-6 mb-16">
                        ...
                        <div class="flex gap-4">
                            <button @click="prev()" aria-label="Testimoni sebelumnya"
                                class="w-12 h-12 rounded-full border border-white/30 flex items-center justify-center hover:bg-white hover:text-[#22AF85] active:scale-95 transition-all text-white">
            ...
            <section id="blog" class="py-20 sm:py-24 px-4 sm:px-6 lg:px-16 max-w-7xl mx-auto scroll-mt-20">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-12">
                    ...
                    <a href="{{ route('blog.index') }}"
                        class="text-sm font-semibold text-[#22AF85] hover:underline flex items-center gap-1">
                        ...
                        <div class="flex gap-4 pt-4">
                            @if(!empty($settings['instagram_link']))
                                <a href="{{ $settings['instagram_link'] }}" target="_blank"
                                    class="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center text-gray-500 hover:bg-[#22AF85] hover:text-white hover:border-[#22AF85] transition-all">
    ...
    @guest
        <!-- Floating Top Banner -->
        <div x-data="registerBanner()" x-init="initBanner()" x-show="isOpen"
            class="fixed top-24 left-1/2 -translate-x-1/2 z-[49] w-[calc(100%-2rem)] max-w-4xl" style="display: none;" x-cloak>
            ...
            <div x-show="isOpen" x-transition:enter="transition ease-out duration-500"
                ...
                <div class="flex items-center gap-3">
                    <div
                        class="w-10 h-10 rounded-xl bg-[#22AF85] flex items-center justify-center text-white flex-shrink-0 shadow-lg shadow-[#22AF85]/20 animate-pulse-soft">
                    ...
                    <div class="text-center md:text-left">
                        ...
                        <p class="text-xs text-gray-400 mt-0.5 font-medium">Daftar sebagai Donatur untuk mendonasikan sepatu
                            bekas Anda & lacak riwayat reparasinya secara real-time.</p>
                    </div>
                </div>
