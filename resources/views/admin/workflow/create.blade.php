        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.workflow.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="icon" name="icon" type="text" class="mt-1 block w-full" :value="old('icon')" placeholder="e.g. 📸" />
                            </div>
                            <div>
                                <x-input-label for="step_order" :value="__('Step Order')" />
                                <x-text-input id="step_order" name="step_order" type="number" class="mt-1 block w-full" :value="old('step_order', 1)" />
                            </div>
                        </div>
