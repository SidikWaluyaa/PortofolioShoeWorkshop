<x-app-layout>
    ...
    <div class="max-w-2xl">
        <form method="POST" action="{{ route('admin.reviews.store') }}" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="flex gap-3">
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="rating" value="{{ $i }}" {{ old('rating', 5) == $i ? 'checked' : '' }} class="text-[#22AF85]">
            ...
            <div>
                ...
                <textarea name="content" rows="4" required
                          ...
                          class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#22AF85] focus:ring-2 focus:ring-[#22AF85]/20">{{ old('content') }}</textarea>
