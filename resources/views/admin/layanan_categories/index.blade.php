            ...
            <tbody class="divide-y divide-gray-100 bg-white">
                ...
                <tr class="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        ...
                        <form action="{{ route('admin.layanan-categories.destroy', $category->id) }}" method="POST" class="inline" onsubmit="confirmAction(event, this, 'Menghapus kategori ini juga akan menghapus semua sub-jasa di dalamnya. Yakin?')">
                            @csrf
                            @method('DELETE')
