                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="category" name="category" type="text" class="mt-1 block w-full" :value="old('category')" placeholder="e.g. Repairs, Cleaning, Repaint" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                            <div>
                                ...
                                <input id="before_image" name="before_image" type="file" class="mt-1 block w-full" required />
                                <x-input-error class="mt-2" :messages="$errors->get('before_image')" />
                            </div>
                            <div>
                                <x-input-label for="after_image" :value="__('After Image')" />
                                <input id="after_image" name="after_image" type="file" class="mt-1 block w-full" required />
                        ...
                        <div class="block mb-4">
                            <label for="is_featured" class="inline-flex items-center">
                                <input id="is_featured" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_featured" value="1">
