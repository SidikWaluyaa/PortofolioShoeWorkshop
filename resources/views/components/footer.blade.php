    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-10 pb-10 border-b border-white/10 mb-8">
            ...
            <div class="col-span-2 lg:col-span-1">
                ...
                <p class="text-sm text-gray-400 leading-relaxed mb-5 max-w-xs">Workshop spesialis reparasi dan perawatan sepatu profesional dengan hasil terbaik.</p>
                <div class="flex gap-3">
                    @if(!empty($settings['instagram_link']))
                    <a href="{{ $settings['instagram_link'] }}" target="_blank" class="w-9 h-9 bg-white/10 hover:bg-[#22AF85] rounded-lg flex items-center justify-center transition-all duration-300 hover:-translate-y-0.5">
                    ...
                    <a href="{{ $settings['tiktok_link'] }}" target="_blank" class="w-9 h-9 bg-white/10 hover:bg-[#22AF85] rounded-lg flex items-center justify-center transition-all duration-300 hover:-translate-y-0.5">
                    ...
                    <a href="{{ $settings['facebook_link'] }}" target="_blank" class="w-9 h-9 bg-white/10 hover:bg-[#22AF85] rounded-lg flex items-center justify-center transition-all duration-300 hover:-translate-y-0.5">
                    ...
                    <a href="https://wa.me/{{ $settings['whatsapp_number'] }}" target="_blank" class="w-9 h-9 bg-white/10 hover:bg-[#22AF85] rounded-lg flex items-center justify-center transition-all duration-300 hover:-translate-y-0.5">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm text-gray-400">
                    ...
                    <li class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-[#22AF85] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 004.516 4.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                        {{ $settings['whatsapp_number'] }}
                    </li>
                    @endif
                    @if(!empty($settings['email']))
                    <li class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-[#22AF85] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                        {{ $settings['email'] }}
                    </li>
                    @endif
                    @if(!empty($settings['address']))
                    <li class="flex items-start gap-2">
                        <svg class="w-4 h-4 text-[#22AF85] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
