        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-10 pb-10 border-b border-white/10 mb-8">
            ...
            <div class="col-span-2 lg:col-span-1">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ $settings['instagram_link'] }}" target="_blank" class="w-9 h-9 bg-white/10 hover:bg-[#22AF85] rounded-lg flex items-center justify-center transition-colors">
                    ...
                    <a href="{{ $settings['tiktok_link'] }}" target="_blank" class="w-9 h-9 bg-white/10 hover:bg-[#22AF85] rounded-lg flex items-center justify-center transition-colors">
                    ...
                    <a href="{{ $settings['facebook_link'] }}" target="_blank" class="w-9 h-9 bg-white/10 hover:bg-[#22AF85] rounded-lg flex items-center justify-center transition-colors">
                    ...
                    <a href="https://wa.me/{{ $settings['whatsapp_number'] }}" target="_blank" class="w-9 h-9 bg-white/10 hover:bg-[#22AF85] rounded-lg flex items-center justify-center transition-colors">
