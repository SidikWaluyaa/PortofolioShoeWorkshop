        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.trust.index')" :active="request()->routeIs('admin.trust.*')">
                        {{ __('Trust Strip') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.workflow.index')" :active="request()->routeIs('admin.workflow.*')">
                        {{ __('Workflow') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.about.index')" :active="request()->routeIs('admin.about.*')">
                        {{ __('About') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.cta.index')" :active="request()->routeIs('admin.cta.*')">
                        {{ __('CTA') }}
                    </x-nav-link>
