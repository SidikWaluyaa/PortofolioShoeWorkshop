    ...
    <body class="font-sans antialiased text-gray-900 bg-gray-50 h-full overflow-hidden" x-data="{ sidebarOpen: false }">
        <div class="flex h-full">
            ...
            <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
                   class="fixed inset-y-0 left-0 z-50 w-72 bg-white border-r border-gray-200 transform lg:translate-x-0 lg:static transition duration-300 ease-in-out flex flex-col shadow-2xl lg:shadow-none h-screen overflow-hidden">
